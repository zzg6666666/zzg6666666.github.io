import{_ as n,o as s,c as a,a as t}from"./app-pkHxpBYY.js";const e={},p=t(`<p>在free RTOS中，基本上所有的动态创建的地方，都需要进行内存管理，为此，free RTOS提供了<code>vPortFree()</code>和<code>pvPortMalloc()</code>，而在C标准库中，也提供了<code>malloc()</code>和<code>free()</code>，但是标准库并没有考虑到嵌入式系统中所存在的资源紧缺的情况。free RTOS提供了多种<code>vPortFree()</code>和<code>pvPortMalloc()</code>，对应不同的情况。</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>heap_1.c    分配简单，不能释放内存
